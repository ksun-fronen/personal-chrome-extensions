const salt = '5337810b0c500ace9c4cd745f4b8bcf5';
...
const encodeString = (function () {
    ...
    r = (function (t, e) {
        ...
        u = mmNF().bin,
        (a = function (t, e) {
            t.constructor == String ? t = e && "binary" === e.encoding ? u.stringToBytes(t) : o.stringToBytes(t) : i(t) ? t = Array.prototype.slice.call(t, 0) : Array.isArray(t) || t.constructor === Uint8Array || (t = t.toString());
            for (var n = r.bytesToWords(t), c = 8 * t.length, f = 1732584193, s = -271733879, l = -1732584194, h = 271733878, p = 0; p < n.length; p++)
